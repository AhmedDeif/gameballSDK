...
//        choicesHeightConstraint.isActive = false
...
//        choicesHeightConstraint?.constant = CGFloat(choices.count) * 20 + CGFloat(choices.count) * 10
    }
...
//        choicesHeightConstraint.isActive = true
//        choicesHeightConstraint.constant = 0
//        choicesHeightConstraint?.constant = 0
    }
    
    private var choicesShown: Bool {
//        return !choicesHeightConstraint.isActive
